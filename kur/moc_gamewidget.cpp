...
QT_MOC_LITERAL(1, 11, 14), // "gameOverSignal"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 12), // "gameOverSlot"
QT_MOC_LITERAL(4, 40, 13) // "nextRoundSlot"

    },
    "GameWidget\0gameOverSignal\0\0gameOverSlot\0"
    "nextRoundSlot"
};
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->gameOverSlot(); break;
        case 2: _t->nextRoundSlot(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWidget::gameOverSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameWidget::gameOverSignal()
{
